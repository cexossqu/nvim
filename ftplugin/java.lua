...
local config = {
  ...
  cmd = {
    ...
    "-javaagent:/home/m/.local/share/nvim/lsp/jdt-language-server/lombok.jar",
    "-Xbootclasspath/a:/home/m/.local/share/nvim/lsp/jdt-language-server/lombok.jar",
	...
	'-jar', '/home/m/.local/share/nvim/lsp/jdt-language-server/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
	...
	'-configuration', '/home/m/.local/share/nvim/lsp/jdt-language-server/config_linux',

    -- 💀
    -- 请参阅 README 中的“数据目录配置”部分
    '-data', '/home/m/.local/share/nvim/lsp/jdt-language-server/workspace/folder'
  },
